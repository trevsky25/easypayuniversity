...
// Diversified LTO Application Process Scenarios
export const ltoCustomerScenarios = [
  ...
  },
  {
    ...
    keyLearningPoints: [
      ...
      "Building credit history education"
    ]
  },
  {
  ...
  {
    id: "process-senior-assisted",
    title: "Senior Customer - Assisted Application Experience",
    difficulty: "intermediate",
    reward: 45,
    scenarioType: "assisted-process",
    customerProfile: {
      name: "Linda Thompson",
